#!/usr/bin/env perl
#
# Test that URI::XS correctly accepts or rejects RFC compliant
# URIs
#
...
while($uri = <DATA>) {
    ...
    if ($isbad && $test_bad) {
        ...
        diag "got wrong result for $uri [$isbad]\n";
        ok(0);
    }
...
# bad
ftp://www.skrenta.com/
https://www.skrenta.com:80/
https://www.skrenta.com:444/
http://www.skrenta.com:443/
...
http://www.example.com/one/two/three/four/five/six/seven/eight/nine/ten/eleven/12/13/14/15/Too_many_levels.html
http://www.foo.com/baz/../bar/index.html
http://www.foo.com/baz/../../bar/index.html
# good
http://www.keskiaika.net/php///////////viewtopic.php?p=22576
http://www.keskiaika.net/php///index.html
http://www.skrenta.com/
https://www.skrenta.com/
http://www.skrenta.com:80/
https://www.skrenta.com:443/
